                        ...
                        <div class="card-body mt-3">
                            ...
                            <div class="card-body h-100">
                                ...
                                <div class="row text-center mx-auto mt-5" style="width: 500px;">
                                    <div class="col-md-6 col-lg-6">
                                        <embed id="myImg" class="inner-img mb-3" src="<?php echo 'https://iverify.ng'.$meansOfID = substr($meansOfID, 2); ?>" style="width:100%;height:300px;"/>
                                    ...
                                    <div class="col-md-6 col-lg-6">
                                        <embed id="myImg" class="inner-img mb-3" src="<?php echo 'https://iverify.ng'.$curriculumVitae = substr($curriculumVitae, 2); ?>" style="width:100%;height:300px;"/>
