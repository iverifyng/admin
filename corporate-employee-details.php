                    ...
                    <div class="card">
                        <div class="card-body mt-3">
                            ...
                            <div class="card-body h-100">
                                ...
                                <a href="<?php echo 'https://iverify.ng'.$meansOfID = substr($meansOfID, 2); ?>" target="_blank" class="btn btn-square btn-info btn-lg"><i class="fas fa-download"></i> View payment proof</a>
                                    <?php 
